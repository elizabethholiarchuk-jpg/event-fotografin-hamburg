        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          <div className="flex flex-col gap-6">
            <nav aria-label="Breadcrumb" className="text-[13px] text-[var(--color-text-muted)] font-light">
              <Link href="/" className="hover:text-[var(--color-accent)] transition-colors">Start</Link>
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              <Link href="/kontakt" className="bg-[var(--color-accent)] text-white px-8 py-3.5 rounded-2xl text-[15px] font-semibold transition-colors hover:bg-[var(--color-accent-hover)]">
                Kontakt
              </Link>
