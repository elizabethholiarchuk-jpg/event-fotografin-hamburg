...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/en/corporate-event-photographer-hamburg",
    languages: {
        en: "/en/corporate-event-photographer-hamburg",
        de: "/corporate-event-fotograf-hamburg",
        'x-default': "/corporate-event-fotograf-hamburg",
      },
  },
  openGraph: {
      locale: "en_US",
    ...
    url: "/en/corporate-event-photographer-hamburg",
    images: [
      {
