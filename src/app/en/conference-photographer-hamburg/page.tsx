...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/en/conference-photographer-hamburg",
    languages: {
        en: "/en/conference-photographer-hamburg",
        de: "/konferenzfotografie-hamburg",
        'x-default': "/konferenzfotografie-hamburg",
      },
  },
  openGraph: {
      locale: "en_US",
    ...
    url: "/en/conference-photographer-hamburg",
    images: [
      {
