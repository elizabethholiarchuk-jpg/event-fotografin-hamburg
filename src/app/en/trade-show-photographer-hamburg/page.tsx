...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/en/trade-show-photographer-hamburg",
    languages: {
        en: "/en/trade-show-photographer-hamburg",
        de: "/messefotograf-hamburg",
        'x-default': "/messefotograf-hamburg",
      },
  },
  openGraph: {
      locale: "en_US",
    ...
    url: "/en/trade-show-photographer-hamburg",
    images: [
      {
