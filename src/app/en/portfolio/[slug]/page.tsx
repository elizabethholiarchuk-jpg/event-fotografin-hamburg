      ...
      <section className="py-16 md:py-24 border-b border-[var(--color-border-hairline)]">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 grid md:grid-cols-3 gap-12 md:gap-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <Link href="/en/contact" className="mt-4 bg-[var(--color-accent)] text-white px-6 py-3 rounded-xl text-[14px] font-semibold transition-colors hover:bg-[var(--color-accent-hover)] text-center">
      ...
      {related.length > 0 && (
        <section className="py-16 md:py-24 border-b border-[var(--color-border-hairline)]">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col gap-8">
            ...
            <Link href="/en/portfolio" className="text-[15px] font-medium text-[var(--color-text-muted)] hover:text-[var(--color-text-main)] transition-colors underline underline-offset-4 w-fit">
              View full portfolio →
            </Link>
          </div>
        </section>
