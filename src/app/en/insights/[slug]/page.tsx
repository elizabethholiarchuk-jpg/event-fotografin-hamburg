    ...
    <>
      ...
      <section className="py-16 md:py-24 border-b border-[var(--color-border-hairline)]">
        <div className="max-w-[900px] mx-auto px-6 md:px-12 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { href: "/en/conference-photographer-hamburg", label: "Conference Photography Hamburg" },
              { href: "/en/trade-show-photographer-hamburg", label: "Trade Show Photography Hamburg" },
              { href: "/en/portfolio", label: "View Portfolio" },
      ...
      <section className="py-24 md:py-32 bg-[#DDE7F0] text-[var(--color-text-main)] flex justify-center text-center">
        <div className="max-w-[700px] w-full px-6 flex flex-col gap-8 items-center">
          ...
          <Link href="/en/contact" className="bg-[var(--color-text-main)] text-white px-10 py-4 text-base font-semibold transition-colors hover:bg-[var(--color-accent-hover)] rounded-2xl">
            Contact Me
          </Link>
        </div>
      </section>
