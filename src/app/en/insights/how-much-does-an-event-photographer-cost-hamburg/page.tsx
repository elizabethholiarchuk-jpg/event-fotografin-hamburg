...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/en/insights/how-much-does-an-event-photographer-cost-hamburg",
      languages: {
  ...
  openGraph: {
    ...
    url: "/en/insights/how-much-does-an-event-photographer-cost-hamburg",
    images: [
      {
      ...
      <section className="pt-32 md:pt-44 pb-16 md:pb-24 border-b border-[var(--color-border-hairline)]">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col gap-6">
          <nav aria-label="Breadcrumb" className="text-[13px] text-[var(--color-text-muted)] font-light">
            ...
            <Link href="/en/insights" className="hover:text-[var(--color-accent)] transition-colors">Insights</Link>
            <span className="mx-2" aria-hidden="true">›</span>
          ...
          <div className="flex items-center gap-4 text-[14px] text-[var(--color-text-muted)]">
            <span>By <Link href="/en/about" className="text-[var(--color-text-main)] font-medium hover:underline underline-offset-2">Liza Holiarchuk</Link></span>
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { href: "/en/event-photographer-hamburg", label: "Event Photography Hamburg" },
              { href: "/en/conference-photographer-hamburg", label: "Conference Photography" },
              { href: "/en/trade-show-photographer-hamburg", label: "Trade Show Photography" },
            ].map((s) => (
              <Link
                key={s.href}
                href={s.href}
        ...
        <div className="max-w-[900px] mx-auto px-6 md:px-12 flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="flex flex-col gap-2 text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-4 mt-1 justify-center md:justify-start">
              <Link href="/en/about" className="text-[14px] text-[var(--color-text-main)] font-medium underline underline-offset-4 decoration-1 hover:text-[var(--color-accent)]">
                About
              </Link>
              <Link href="/en/contact" className="text-[14px] text-[var(--color-text-main)] font-medium underline underline-offset-4 decoration-1 hover:text-[var(--color-accent)]">
                Contact
              </Link>
            </div>
          </div>
