...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/en/event-photographer-hamburg",
    languages: {
        en: "/en/event-photographer-hamburg",
        de: "/eventfotograf-hamburg",
        'x-default': "/eventfotograf-hamburg",
      },
  },
  openGraph: {
      locale: "en_US",
    ...
    url: "/en/event-photographer-hamburg",
    images: [
      {
