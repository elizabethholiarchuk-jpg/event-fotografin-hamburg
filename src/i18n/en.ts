...
export const en: Dictionary = {
  ...
  corporateEventFotografie: {
    hero: {
      ...
      subtitle: "Awards nights, internal events, company anniversaries and executive gatherings — photographed with discretion and delivered fast.",
    },
  ...
  kontakt: {
    ...
    form: {
      ...
      howFound: "How did you hear about me?",
      howFoundPlaceholder: "Please choose",
      howFoundOptions: {
        ...
        other: "Another / Other source"
      },
      referralWho: "Who referred you?",
      referralWhoPlaceholder: "Name or company...",
      otherSource: "Please specify where you found me",
      otherSourcePlaceholder: "Where did you hear about me?...",
