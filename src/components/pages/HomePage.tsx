  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-[92vh] md:min-h-screen flex items-end justify-start bg-[var(--color-dark-bg)] overflow-hidden pb-16 md:pb-24 pt-40 md:pt-48">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto w-full px-6 md:px-12 text-white flex flex-col gap-10 md:gap-12">
          <div className="max-w-[1100px] flex flex-col gap-6 md:gap-8">
            ...
            <p className="text-2xl md:text-4xl font-light leading-snug text-white/95 max-w-[45ch]" dangerouslySetInnerHTML={{ __html: t.hero.subtitle }}>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            <div className="flex flex-col gap-6 group">
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-2xl md:text-3xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.useCases.marketing.title}</h3>
                <p className="text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed">{t.useCases.marketing.desc}</p>
              </div>
            </div>
            <div className="flex flex-col gap-6 group">
              <div className="relative aspect-[4/5] overflow-hidden rounded-[20px] border border-gray-100 shadow-sm">
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-2xl md:text-3xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.useCases.presse.title}</h3>
                <p className="text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed">{t.useCases.presse.desc}</p>
              </div>
            </div>
            <div className="flex flex-col gap-6 group">
              <div className="relative aspect-[4/5] overflow-hidden rounded-[20px] border border-gray-100 shadow-sm">
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-2xl md:text-3xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.useCases.intern.title}</h3>
                <p className="text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed">{t.useCases.intern.desc}</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-14 md:py-24 bg-transparent">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col lg:flex-row justify-between gap-10 lg:gap-24">
          <div className="w-full lg:w-1/3 flex flex-col gap-4">
            <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.services.title}</h2>
          </div>
          <div className="w-full lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
            <div className="flex flex-col gap-3">
              <h3 className="text-xl font-semibold text-[var(--color-text-main)]">{t.services.konferenz.title}</h3>
              <p className="text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed">{t.services.konferenz.desc}</p>
            </div>
            <div className="flex flex-col gap-3">
              <h3 className="text-xl font-semibold text-[var(--color-text-main)]">{t.services.messe.title}</h3>
              <p className="text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed">{t.services.messe.desc}</p>
            </div>
            <div className="flex flex-col gap-3">
              <h3 className="text-xl font-semibold text-[var(--color-text-main)]">{t.services.corporate.title}</h3>
              <p className="text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed">{t.services.corporate.desc}</p>
            </div>
            <div className="flex flex-col gap-3">
              <h3 className="text-xl font-semibold text-[var(--color-text-main)]">{t.services.video.title}</h3>
              <p className="text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed">{t.services.video.desc}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 md:py-24 bg-transparent border-y border-[var(--color-border-hairline)]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col gap-10 md:gap-14">
          <div className="flex flex-col gap-2">
            <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.outcomes.title}</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <h3 className="text-xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.outcomes.delivery.title}</h3>
                <p className="text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed">{t.outcomes.delivery.desc}</p>
              </div>
            </div>
            <div className="flex flex-col gap-5">
              <div className="relative aspect-[4/3] overflow-hidden rounded-[20px] border border-gray-100 shadow-sm">
              ...
              <div className="flex flex-col gap-2">
                <h3 className="text-xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.outcomes.consistent.title}</h3>
                <p className="text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed">{t.outcomes.consistent.desc}</p>
              </div>
            </div>
            <div className="flex flex-col gap-5">
              <div className="relative aspect-[4/3] overflow-hidden rounded-[20px] border border-gray-100 shadow-sm">
              ...
              <div className="flex flex-col gap-2">
                <h3 className="text-xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.outcomes.gallery.title}</h3>
                <p className="text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed">{t.outcomes.gallery.desc}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 md:py-24 bg-transparent">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col gap-10 md:gap-14">
          <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.packages.title}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 divide-y md:divide-y-0 md:divide-x divide-[var(--color-border-hairline)] border-t border-[var(--color-border-hairline)] pt-12">
            <div className="flex flex-col gap-6 md:pr-10">
              <h3 className="text-xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.packages.full.title}</h3>
              <ul className="list-disc pl-5 flex flex-col gap-3 text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed marker:text-[var(--color-text-main)]">
                {t.packages.full.items.map((item, i) => <li key={i}>{item}</li>)}
              </ul>
            </div>
            <div className="flex flex-col gap-6 pt-10 md:pt-0 md:px-10">
              <h3 className="text-xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.packages.half.title}</h3>
              <ul className="list-disc pl-5 flex flex-col gap-3 text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed marker:text-[var(--color-text-main)]">
                {t.packages.half.items.map((item, i) => <li key={i}>{item}</li>)}
              </ul>
            </div>
            <div className="flex flex-col gap-6 pt-10 md:pt-0 md:pl-10">
              <h3 className="text-xl font-semibold tracking-tight text-[var(--color-text-main)]">{t.packages.addons.title}</h3>
              <ul className="list-disc pl-5 flex flex-col gap-3 text-[var(--color-text-muted)] text-[17px] font-normal leading-relaxed marker:text-[var(--color-text-main)]">
                {t.packages.addons.items.map((item, i) => <li key={i}>{item}</li>)}
              </ul>
            </div>
          </div>
          <div className="pt-4">
